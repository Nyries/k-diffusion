...
"""File containing the architecture of configuration F of Karra et al. paper: Analyzing and Improving the Training Dynamics of Diffusion Models.
This configuration's is called remove group normalizations.
In addition to removing group normalization there is also a global simplification of the architecture."""
...
class ConfigFDenoiser(nn.Module):
