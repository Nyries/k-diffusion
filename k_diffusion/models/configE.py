...
"""File containing the architecture of configuration E of Karra et al. paper: Analyzing and Improving the Training Dynamics of Diffusion Models.
This configuration's is called control effective learning rate.
It changes the learning rate schedule (see utils.py: KingmaLR) and introduce the normalize function and the way to use it in active layers."""
...
class ConfigEDenoiser(nn.Module):
